...
public class SimpleXMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        // ALTER BY STRIVEYEE: modify namespace mapper to dao
        String namespace = introspectedTable.getDAOInterfaceType();
    ...
    protected void addAllFieldsElement(XmlElement parentElement) {
        initializeAndExecuteGenerator(new AllFieldsElementGenerator(), parentElement);
    }
